...
function App() {
  ...
  const availableDogs = [
    ...
    },
    {
      id: 7,
      name: "Apollo",
      breed: "Micro Maltipoo",
      age: "9 hetes",
      price: "300.000 Ft",
      image: microApollo,
      description: "Micro Maltipoo kölyök, világos krém szőrzet, nagyon intelligens és tanulékony természet. Apollo egy kivételesen okos kis kutya, aki gyorsan megtanulja a parancsokat és imádja a játékot.",
      gender: "Fiú",
      vaccinated: true,
      weight: "3 kg",
      parents: "Máltai selyemkutya anya × Micro uszkár apa",
      temperament: "Intelligens, játékos, tanulékony",
      specialFeatures: ["Micro méret", "Rendkívül okos", "Gyorsan tanul", "Ideal lakásba"],
      category: "maltipoo"
    },
    {
      id: 8,
      ...
      price: "300.000 Ft",
      image: microZeus,
      description: "Micro Maltipoo kölyök, fehér-barna szőrzet, energikus és barátságos természet. Zeus egy igazi kis energiabomba, aki mindig vidám és szereti a társaságot.",
      gender: "Fiú",
      vaccinated: true,
      weight: "3 kg",
      parents: "Máltai selyemkutya anya × Micro uszkár apa",
      temperament: "Energikus, barátságos, vidám",
      specialFeatures: ["Micro méret", "Nagyon energikus", "Barátságos", "Társaságkedvelő"],
      category: "maltipoo"
    },
    {
      id: 9,
      ...
      price: "300.000 Ft",
      image: microAtlas,
      description: "Micro Maltipoo kölyök, arany-krém szőrzet, nyugodt és szeretetteljes természet. Atlas egy szelíd, ragaszkodó kis kutya, aki tökéletes családi kedvenc.",
      gender: "Fiú",
      vaccinated: true,
      weight: "3 kg",
      parents: "Máltai selyemkutya anya × Micro uszkár apa",
      temperament: "Szelíd, ragaszkodó, szeretetteljes",
      specialFeatures: ["Micro méret", "Szelíd természet", "Ragaszkodó", "Családi kedvenc"],
      category: "maltipoo"
    },
    {
      id: 10,
      ...
      price: "300.000 Ft",
      image: microLuna,
      description: "Micro Maltipoo kölyök, fehér-krém szőrzet, nyugodt és intelligens természet. Luna egy kivételesen szelíd kis kutya, aki imádja a simogatást és a csendes játékokat.",
      gender: "Szuka",
      vaccinated: true,
      weight: "3 kg",
      parents: "Máltai selyemkutya anya × Micro uszkár apa",
      temperament: "Szelíd, intelligens, nyugodt",
      specialFeatures: ["Micro méret", "Kivételesen szelíd", "Intelligens", "Ideal családba"],
      category: "maltipoo"
    },
    {
      id: 11,
      ...
      price: "300.000 Ft",
      image: microNova,
      description: "Micro Maltipoo kölyök, arany-barna szőrzet, energikus és játékos természet. Nova egy igazi kis csillag, aki mindig vidám és szereti a kalandokat.",
      gender: "Szuka",
      vaccinated: true,
      weight: "3 kg",
      parents: "Máltai selyemkutya anya × Micro uszkár apa",
      temperament: "Energikus, játékos, kalandvágyó",
      specialFeatures: ["Micro méret", "Nagyon energikus", "Játékos", "Kalandvágyó"],
      category: "maltipoo"
    },
    {
      id: 12,
      ...
      price: "300.000 Ft",
      image: microAurora,
      description: "Micro Maltipoo kölyök, világos szőrzet, szeretetteljes és ragaszkodó természet. Aurora egy gyönyörű kis kutya, aki mindig szeretetteljes és hűséges társ.",
      gender: "Szuka",
      vaccinated: true,
      weight: "3 kg",
      parents: "Máltai selyemkutya anya × Micro uszkár apa",
      temperament: "Szeretetteljes, ragaszkodó, barátságos",
      specialFeatures: ["Micro méret", "Szeretetteljes", "Ragaszkodó", "Hűséges társ"],
      category: "maltipoo"
    }
  ]
